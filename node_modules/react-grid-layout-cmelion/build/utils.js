...
var utils = module.exports = {
  ...
  correctBounds: function correctBounds(layout, bounds) {
    ...
    for (var i = 0, len = layout.length; i < len; i++) {
      var l = layout[i];
      // Overflows right (don't correct we want to allow overflowing visible container.
   ...
   * @return {LayoutItem}    Item at Coordinates.
   */
  getLayoutItemXY: function getLayoutItemXY(layout, coords) {
    for (var i = 0, len = layout.length; i < len; i++) {
      if (layout[i].x === coords.x && layout[i].y === coords.y) {
        return layout[i];
      }
    }
  },
